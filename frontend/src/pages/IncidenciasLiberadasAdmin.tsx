...
function IncidenciasLiberadasAdmin() {
    ...
    //SACAR INCIDENCIAS LIBERADAS
    async function obtenerIncidencias() {
        try {
            const response = await fetch(HOST + "api/verIncidenciasLiberadasAdmin", {
                method: 'GET',
                headers: {
...
export default IncidenciasLiberadasAdmin;