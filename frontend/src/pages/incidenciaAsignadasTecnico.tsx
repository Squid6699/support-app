...
import ModalSolicitarPieza from "../components/ModalSolicitarPieza";
...
function IncidenciasAsignadasTecnico() {
    ...
    const [openModalSolicitarPieza, setOpenModalSolicitarPieza] = useState(false);
    const [incidenciaParaPieza, setIncidenciaParaPieza] = useState<Incidencias | null>(null);

    const handleOpenModalPieza = (incidencia: Incidencias) => {
        setIncidenciaParaPieza(incidencia);
        setOpenModalSolicitarPieza(true);
    }

    const handleModalClosePieza = () => {
        setOpenModalSolicitarPieza(false);
        setIncidenciaParaPieza(null);
    }
    ...
    return (
        ...
        <>
            ...
            <ModalSolicitarPieza
                open={openModalSolicitarPieza}
                incidencia={incidenciaParaPieza}
                handleModalClose={handleModalClosePieza}
                refetchIncidencias={refetchIncidencias}
            />
        </>
