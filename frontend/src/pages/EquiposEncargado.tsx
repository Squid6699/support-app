...
function EquiposEncargado() {
    ...
    const { data: aulas, isLoading, refetch } = useQuery<AulaEquipos[]>({
        queryKey: ["AulasConEquiposEncargado"],
        queryFn: obtenerAulasConEquiposEncargado,
    });
    ...
    async function obtenerAulasConEquiposEncargado() {
        const response = await fetch(HOST + "api/obtenerEquiposPorAulaEncargado/" + id, {
            method: "GET",
            headers: {
